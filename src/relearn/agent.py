...
from relearn.env import RelearnChemicalEnv
...
# see env.py's one-step-horizon TODO), so num_episodes here is really a transition count.
# it must clear BATCH_SIZE or optimize_model() never runs.
num_episodes = 300
